...
This project covers an example of replaceing React Redux with custom hooks. The application, manages state and handles context within a store and replaces React Redux within `store.js` and `product-store.js`.
